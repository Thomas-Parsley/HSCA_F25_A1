...
add wave -color gold -hex /testbench/dut/clk
...
add wave -noupdate -divider -height 32 "wdunit"
add wave -hex /testbench/dut/rv32single/dp/wdu/*
...
add wave -hex /testbench/dut/rv32single/c/branchunit/*
add wave -noupdate -divider -height 32 "Load/Store Unit"
add wave -hex /testbench/dut/rv32single/c/lsu/*
...
add wave -hex /testbench/dut/dmem/RAM[1028:1024]
